...
async def channel_post(client: Client, message: Message):
    reply_text = await message.reply_text("Sabar ya...!", quote = True)
    try:
        ...
        print(e)
        await reply_text.edit_text("Terjadi suatu masalah..!")
        return
    ...
    reply_markup = InlineKeyboardMarkup([[InlineKeyboardButton("🔁 LINK ASUPAN", url=f'https://telegram.me/share/url?url={link}')]])
